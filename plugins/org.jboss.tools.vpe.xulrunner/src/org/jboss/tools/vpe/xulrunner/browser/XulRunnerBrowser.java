...
public class XulRunnerBrowser implements 
	...
	private JavaFXBrowser browser = null;
//	private nsIWebBrowser webBrowser = null;
	...
	public XulRunnerBrowser(Composite parent) throws XulRunnerException {
		...
		try {
			browser = new JavaFXBrowser(parent); // will work with NONE and WEBKIT too!
		} catch (SWTError e) {
...
//	}
	 ...
	 * @return the browser
	 */
	public JavaFXBrowser getBrowser() {
		return browser;
	}
//	
...
//	}
	...
	public void setBrowser(JavaFXBrowser browser) {
