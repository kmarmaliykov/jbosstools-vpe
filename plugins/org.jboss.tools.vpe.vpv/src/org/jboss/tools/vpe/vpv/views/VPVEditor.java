...
//		fillLocalToolBar(bars.getToolBarManager());
	...
	private void inizializeEditorListener(Browser browser, int modelHolderId ) {
		...
		Command save = commandService.getCommand("org.eclipse.ui.file.save");
		save.addCommandListener(new ICommandListener() {
			
			@Override
			public void commandChanged(CommandEvent arg0) {
				System.out.println(1);
			}
		});
		save.addExecutionListener(new IExecutionListener() {
